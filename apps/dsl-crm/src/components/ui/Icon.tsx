...
export type IconProps = IconDomProps &
  UtilityPropBag & {
    children?: ReactNode;
...
export const Icon = forwardRef<HTMLElement, IconProps>(
  (
    ...
    const baseClasses = cn(defaultProps, sizeClasses, utilityClassName, className);
    ...
    return (
      ...
      >
        <If test="LucideIcon" value={!!LucideIcon}>
          <LucideIcon className={cn(sizeClasses, utilityClassName, className)} strokeWidth={strokeWidth} />
          <Else>{children}</Else>
        </If>
      </ComponentWithRef>
    );
