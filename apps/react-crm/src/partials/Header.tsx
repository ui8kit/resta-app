    ...
    <Block component="header" py="2" bg="background" border="b" shadow="sm" data-class={dataClass ?? dataClassAttr ?? 'header'}>
      <Container max="w-6xl" mx="auto" px="4" flex="" justify="between" items="center" gap="8" data-class="header-container">
        ...
        <Group gap="0" items="center" data-class="header-nav-group">
          ...
          {beforeThemeToggle}
          <ThemeToggle />
          {isAuthenticated ? (<><Button variant="link" size="sm" onClick={handleLogout} title="Logout" aria-label="Logout" data-class="header-admin-link-logout"><Icon lucideIcon={LogOut} size="sm" data-class="header-admin-icon"></Icon></Button></>) : (<><DomainNavButton variant={"link"} size={"sm"} href={"/admin"} title={"Admin / Login"} aria-label={"Admin / Login"} data-class={"header-admin-link-login"}><Icon lucideIcon={LogIn} size="sm" data-class="header-admin-icon"></Icon></DomainNavButton></>)}
        </Group>
      </Container>
    </Block>
  );
