...
describe('Logger', () => {
  ...
  describe('prefix', () => {
    it('should include prefix in log messages', () => {
      ...
      expect(consoleInfo).toHaveBeenCalledWith(expect.stringContaining('[MyService]'));
    });
    ...
    it('should not include prefix when not specified', () => {
      ...
      expect(consoleInfo).toHaveBeenCalledWith(expect.not.stringContaining('['));
    });
  });
  ...
  describe('child', () => {
    ...
    it('should work without parent prefix', () => {
      ...
      expect(consoleInfo).toHaveBeenCalledWith(expect.stringContaining('[Child]'));
    });
  });
  ...
  describe('additional arguments', () => {
    it('should pass additional arguments to console', () => {
      ...
      expect(consoleInfo).toHaveBeenCalledWith(expect.any(String), extraData);
    });
    ...
    it('should handle multiple additional arguments', () => {
      ...
      expect(consoleInfo).toHaveBeenCalledWith(expect.any(String), 'arg1', 'arg2', 123);
    });
  });
});
