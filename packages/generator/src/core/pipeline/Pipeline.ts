 ...
 */
export function createPipelineContext(baseContext: IServiceContext, signal?: AbortSignal): IPipelineContext {
...
export class Pipeline implements IPipeline {
   ...
   */
  private async runStage(stage: IPipelineStage, input: unknown, context: IPipelineContext): Promise<StageResult> {
    const startTime = performance.now();
