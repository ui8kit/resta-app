 ...
 */
export function analyzeExpression(node: t.Expression, source: string): AnalyzedExpression {
 ...
 */
function analyzeLoopExpression(node: t.Expression, source: string): Partial<AnalyzedExpression> | null {
 ...
 */
function analyzeLogicalExpression(node: t.Expression, source: string): Partial<AnalyzedExpression> | null {
 ...
 */
function analyzeTernaryExpression(node: t.Expression, source: string): Partial<AnalyzedExpression> | null {
