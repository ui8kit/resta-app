...
// vite-plugin-dts removed: @microsoft/api-extractor ESM build uses extensionless
// relative imports, causing ERR_MODULE_NOT_FOUND in Node.js. Declarations are
// generated by tsc in the build script instead.
